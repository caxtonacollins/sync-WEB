...
import { useSyncPayStats } from "@/hooks/api";
...
import { SyncPaySkeleton } from "@/components/skeletons/SyncPaySkeleton";
...
export default function SyncPayTokenPage() {
  ...
  const { data: stats, isLoading, isError, refetch: refetchStats } = useSyncPayStats();

  useEffect(() => {
    if (isError) {
      addToast("Failed to load SyncPay stats", "error");
    }
  }, [isError]);
  ...
  const loadSyncPayStats = async () => {
    try {
      ...
      console.error("Failed to refresh SyncPay stats:", error);
      addToast("Failed to refresh SyncPay stats", "error");
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-400">
                Native token with staking rewards, fee discounts, and governance
              </p>
            </div>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-semibold">SYNCPAY</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    {[
                      {
                        ...
                        description: "Proposal to increase APY from 25% to 30%",
                        votesFor: 1250,
                        votesAgainst: 320,
                        status: "active",
                      },
